...
class BillTest {
    ...
    //    Pour tester  generate , nous allons créer un faux  Writer  :
    //    un  Writer  qui n'écrit rien du tout, mais qui stocke ce qu'il doit écrire.
    ...
    //    On creer des produit pour les tests
