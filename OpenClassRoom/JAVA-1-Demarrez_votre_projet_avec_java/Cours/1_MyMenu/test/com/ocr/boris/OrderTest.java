...
//----------------Ajout option accompagnement menus ---------
    ...
    public void Given_VegetablesAndAllSides_When_DisplaySideSelected_Then_DisplayVegetablesSentence() {
        ...
        String output = outContent.toString().replace("\r\n", "\n");
//        DOC : https://openclassrooms.com/fr/courses/4975451-demarrez-votre-projet-avec-java/5042376-ajoutez-de-nouvelles-fonctionnalites#/id/r-5042432
//         transforme les retours à la ligne Linux et Windows sous le même format
